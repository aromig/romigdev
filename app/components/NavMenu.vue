...
<template>
  <nav role="navigation" class="nav">
    <div id="menuToggle">
      <input id="navToggle" type="checkbox" ref="menuToggle" />
      <span></span>
      <span></span>
      <span></span>
      <ul id="menu">
        <li><NuxtLink to="/blog" @click="closeMenu">Blog</NuxtLink></li>
        <li><NuxtLink to="/resume" @click="closeMenu">Resume</NuxtLink></li>
